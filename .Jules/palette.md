...
## 2024-06-18 - [Accessibility: Hiding Injected Decorative Emojis]
**Learning:** When programmatically injecting decorative emojis into the DOM via JS, using .innerText will expose them to screen readers.
**Action:** Always wrap purely decorative emojis in <span aria-hidden="true"> and inject them using .innerHTML to ensure they are hidden from assistive technologies.
