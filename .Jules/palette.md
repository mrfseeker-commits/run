...
## 2024-05-29 - Dynamically Injected Emojis
**Learning:** When programmatically injecting HTML elements (e.g., wrapping emojis in <span aria-hidden="true">) for accessibility into DOM elements via JavaScript, using .innerText will render the literal HTML tags instead of applying them.
**Action:** Always ensure you use .innerHTML rather than .innerText when updating the DOM with dynamic content that includes HTML tags like aria-hidden spans.
